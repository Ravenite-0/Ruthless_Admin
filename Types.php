...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-cube"></i> Property Types
                        </li>
                    </ol>
                </div>
            </div>
            ...
            ?>
            <div>
                <!-- Creates a table that shows the TYPE data. -->
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped col-lg-5 ">
                        ...
                        <?php }else{
                        //Using while loop to display available data.
                        while ($row = $result->fetch_array()) { ?>

                            <tr>
                                <td><?php echo $row[1] ?></td>
                                <!-- Creates 2 functional buttons. -->
                                <td align="center">
                                    <a href="Type_Modify.php?typeid=<?php echo $row["TYPE_ID"]; ?>&Action=Update"><b><u>Update</u></b></a>
                                    &nbsp;
                                    <a href="Type_Modify.php?typeid=<?php echo $row["TYPE_ID"]; ?>&Action=Delete"><b><u>Delete</u></b></a>
                                </td>
                            </tr>
                    ...
                    <div style="text-align: center">
                        <input type="button" value="+ Add New Record"
                               onClick="window.location='Type_Modify.php?Action=Insert'"
